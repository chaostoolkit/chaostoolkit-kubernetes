...
def test_create_network_policy_from_spec(cl, client, has_conf):
    ...
    spec = {
        ...
        "kind": "NetworkPolicy",
        "metadata": {"name": "deny-all-ingress-to-foo"},
        "spec": {"podSelector": "app=foo", "policyTypes": ["Ingress"], "ingress": []},
    }
    ...
    v1.create_namespaced_network_policy.assert_called_with("default", body=spec)
